        ...
        java = {
            ...
            configuration = {
                ...
                runtimes = {
                    {
                        name = "JavaSE-11",
                        path = "/opt/homebrew/opt/sdkman-cli/libexec/candidates/java/11.0.17-tem",
                    },
                    {
                        name = "JavaSE-17",
                        path = "/opt/homebrew/opt/sdkman-cli/libexec/candidates/java/17.0.5-tem",
                    },
                    {
                        name = "JavaSE-19",
                        path = "/opt/homebrew/opt/sdkman-cli/libexec/candidates/java/19.0.1-tem",
                    },
                },
            },
        },
